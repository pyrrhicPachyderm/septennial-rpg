...
\simpletable{List of Skills}{skill-list}{XX}{
	...
	\midrule
	\capital{\skillref{aim}} & \capital{\skillref{conjuration}}\\
	\capital{\skillref{athletics}} & \capital{\skillref{divination}}\\
	...
	\capital{\skillref{fight}} & \capital{\skillref{metamagic}}\\
	\capital{\skillref{investigation}} & \capital{\skillref{necromancy}}\\
	\capital{\skillref{leadership}} & \capital{\skillref{restoration}}\\
	\capital{\skillrefspeciality{lore}{\variousspeciality}} & \capital{\skillref{sorcery}}\\
...
\optionalrule{Using Spare XP}{
	...
	Each point of spare XP in a skill (XP earned since last increasing the skill's rank, up to 3) allows a player to take +1 on a {\test} using that skill, once per session.
...
Objects and creatures created by novice \practitioners{conjuration} are usually temporary, but skilled \practitioners{conjuration} will learn how to make their creations permanent.

\skill{Divination}{divination}

Used to obtain information by magic.
\capital{\discref{divination}} allows a wizard to scry on remote locations, sense things beyond normal perception, pierce illusions, and otherwise to discover whatever they cannot learn mundanely.

\skill{Enchanting}{enchanting}

Used to bind magical power into objects.
\capital{\discref{enchanting}} can invest objects with the ability to generate magical effects independently of a wizard, among other things.
...
\capital{\discref{illusion}} can cause people to see things that don't exist, to perceive one thing as another, or not to notice something at all.
...
The most obvious application of \discref{kinetics} is simply telekinesis.
...
\capital{\discref{metamagic}} spells often affect other spells, empowering them, cancelling them, or otherwise altering them.
...
In the former application, \discref{necromancy} allows the animation of undead or communion with spirits.
In the latter application, it directly weakens, wounds, or kills, without any need for the fire of \discref{sorcery} or the bludgeon of \discref{kinetics}.
\capital{\discref{necromancy}} is perhaps the most feared form of magic, and its use is often highly regulated.

\skill{Restoration}{restoration}

Used to restore things to a previous state, or to enhance them to a better state.
\capital{\discref{restoration}} is most well known for its use in healing people, but it can also heal animals and plants, or even repair damaged or destroyed objects.
...
Detractors of \discref{sorcery} say it's nothing but throwing fireballs, and it's true that the discipline often favours power over finesse.
But modern \discref{sorcery} also encompasses the control, containment, and destruction of energy, and thus has a much wider variety of uses.
Including warding against fireballs.

\skill{Transmutation}{transmutation}

Used to transform things into other things.
\capital{\discref{transmutation}} may affect nonliving things, such as turning lead into gold; living things, such as turning people into animals; or turn one into the other, such as turning a person to stone.
