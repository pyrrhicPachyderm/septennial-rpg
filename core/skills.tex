...
For novices, objects and creatures created by \skillref{conjuration} are usually temporary, but skilled users will learn how to make their creations permanent.
...
\capital{\skillref{illusion}} can cause people to see things that don't exist, to perceive one thing as another, or not to notice something at all.
...
In the latter application, it directly weakens, wounds, or kills, without any need for the fire of \skillref{sorcery} or the bludgeon of \skillref{kinetics}.
...
\capital{\skillref{restoration}} is most well known for its use in healing people, but it can also heal animals and plants, or even repair damaged or destroyed objects.
...
Detractors of \skillref{sorcery} say it's nothing but throwing fireballs, and it's true that the discipline often favours power over finesse.
But modern \skillref{sorcery} also encompasses the control, containment, and destruction of energy, and thus has a much wider variety of uses.
